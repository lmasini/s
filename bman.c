...
*
*    int buf_insert(int k, char *s)                     .. file buffer.c
*        Insert s as the k-th buffer line; tell if successful.
*
*    int buf_replace(int k, char *s)                    .. file buffer.c
...
static int
    ...
    out_of_memory = 0;     /* does buffer ran out of memory? */
...
/* b_nomemory - tell if the buffer module ran out of memory */
int b_nomemory()
{
